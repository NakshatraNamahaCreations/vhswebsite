...
function Homepagebanner() {
  ...
  const postbanner = async (e) => {
    ...
    try {
      const config = {
        ...
        method: "post",
        baseURL: "https://vijayhomesuperadmin/api",
  ...
  const getcategory = async () => {
    let res = await axios.get("https://vijayhomesuperadmin/api/getcategory");
    if ((res.status = 200)) {
  ...
  const getbannerimg = async () => {
    let res = await axios.get("https://vijayhomesuperadmin/api/userapp/getallhomebanner");
    if ((res.status = 200)) {
  ...
  const deletebannerimg = async (id) => {
    axios({
      method: "post",
      url: "https://vijayhomesuperadmin/api/userapp/deletehomebanner/" + id,
    })
                      ...
                      return (
                        <tr key={i}>
                          ...
                          <td>
                            ...
                            src={`https://vijayhomesuperadmin/homepagebanner/${element.banner}`}
                              width={"100px"}
                              height={"50px"}
                            />
                          </td>
