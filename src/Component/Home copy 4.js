...
export default function Home() {
  ...
  const handleChange = (selectedCity) => {
    ...
    navigate(`/${cityName.toLowerCase()}`); // Update the URL
  };
...
//   useEffect(() => {
//     const cityFromUrl = location.pathname.split('/')[1]; // Get the first segment after "/"
//     if (cityFromUrl) {
...
//   const handleChange = (selectedCity) => {
//     setActiveCity(selectedCity.city);
//     setOpenResetModal(false);
//     navigate(`/${selectedCity.city.toLowerCase()}`); // Update the URL
//   };
