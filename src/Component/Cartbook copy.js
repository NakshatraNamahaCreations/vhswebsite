...
function Cartbook() {
  ...
  //       const planPrice = parseFloat(item?.planPrice?.trim());

  //       if (!isNaN(offerPrice) && !isNaN(quantity) && !isNaN(planPrice)) {
  //         const subtotal = planPrice * quantity + MyCartaddonItmes.planPrice;
  //         const planSubtotal =
  //           offerPrice * quantity + MyCartaddonItmes.oferprice;
  ...
  //       (newCartTotal.planSubtotal * voucherdata.discountPercentage) / 100;
  ...
  //   }
  // }, [MyCartItmes, voucherCodeValue, voucherdata]);
  ...
  const renderSlots = () => {
    ...
    //         markerCoordinate: selectedPlaceAddress,
    //       },
    //     };
    ...
    //       // Uncomment and implement your logic as needed
    //       // deleteAllCartItems();
